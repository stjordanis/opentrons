...
from robot_server.service.models.json_api.factory import generate_json_api_models
...
def test_json_api_model__list_response():
    ItemRequest, ItemResponse = generate_json_api_models('item', ItemModel, list_response=True)
    assert ItemRequest == RequestModel[RequestDataModel[Literal['item'], ItemModel]]
